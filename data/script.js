...
var gaugeWaterTemp = new RadialGauge({
...
var gaugeAirTemp = new LinearGauge({
  renderTo: 'gauge-air-temperature',
  width: 120,
  height: 400,
  units: "Temperature (C)",
  minValue: 0,
...
var gaugeAirHum = new RadialGauge({
  renderTo: 'gauge-air-humidity',
  width: 300,
  height: 300,
  units: "Humidity (%)",
  minValue: 0,
